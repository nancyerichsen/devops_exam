...
def create_app(test_config=None):
    ...
    # Get the configuration from environment variables or use default values
    ...
    config_path = config_mapping.get(config_name)
    if config_path is None:
        raise ValueError(f"Error - Invalid FLASK_ENV: {config_name}")
